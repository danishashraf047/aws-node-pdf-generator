...
function createHeaderPolygon(): React.ReactElement {
  ...
  const polygon2 = React.createElement('POLYGON', {
    key: 2,
    id: 'Fill-1',
    fill: '#b01d1c',
  ...
  const g4 = React.createElement('G', { id: 'Clip-2', key: 1 }, null);
  ...
  const g2 = React.createElement(
    'G',
    { id: 'COVER-1-DE', transform: 'translate(-150.000000, -106.000000)' },
    g3,
  );
...
function createCoverPage(props: CoverProps): React.ReactElement {
  ...
  const mgImage = React.createElement('IMAGE', { style: styles.image, source: margin }, null);
  ...
  return React.createElement('VIEW', { style: styles.root, key: 'cover' }, children);
}
