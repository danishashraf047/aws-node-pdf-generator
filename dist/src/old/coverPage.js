...
function createHeaderBackground() {
    const polygon = react_1.default.createElement('POLYGON', { id: 'path-1', points: '0 0 408.8976 0 408.8976 136.063 0 136.063' });
    const defs = react_1.default.createElement('DEFS', { key: 'defs' }, polygon);
    const headerPolygon = react_1.default.createElement('POLYGON', {
        id: 'Fill-1',
        fill: '#b01d1c',
        points: '408.8976 0 408.8976 136.063 -0.0004 136.063 -0.0004 27.213 291.7696 27.213 297.4396 0',
        style: { fillOpacity: 0.85 },
    });
    const g = react_1.default.createElement('G', { id: 'PDF', stroke: 'none', strokeWidth: '1', fill: 'none', fillRule: 'evenodd', key: 'g' }, headerPolygon);
    return react_1.default.createElement('SVG', { key: 'svg', width: '409px', height: '137px', viewBox: '0 0 409 137', style: styles.svg }, [defs, g]);
}
...
function createCoverPage(props) {
    ...
    const mgImage = react_1.default.createElement('IMAGE', { style: styles.image, source: images_1.margin });
    ...
    return react_1.default.createElement('VIEW', { style: styles.root }, children);
}
